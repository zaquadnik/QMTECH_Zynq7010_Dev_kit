...
HD_PWD='D:/Engineering/Projekty/FPGA/Xilinx/Zynq7010_qmtech/Zynq7010_qmtech.runs/Accelerator_ip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Accelerator_ip_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Accelerator_ip_0.tcl
